...
public class SulphurBlockFlintAndSteelProcedure {
	public static InteractionResult execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		double portalY = 0;
		double portalZ = 0;
		if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == SimplySulphurModBlocks.SULPHUR_BLOCK.get()) {
			if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.FLINT_AND_STEEL) {
				...
				if (world instanceof Level _level && !_level.isClientSide())
					_level.explode(null, x, y, z, (float) 2.7, Level.ExplosionInteraction.BLOCK);
